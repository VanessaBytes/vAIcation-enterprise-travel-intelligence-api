...
# All LLM calls use Nebius Token Factory in this version. Nebius does not
# support reasoning_effort, so both calls omit it.
SYNTH_MODEL = "meta-llama/Llama-3.3-70B-Instruct"
